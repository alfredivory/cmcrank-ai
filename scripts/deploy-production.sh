...
# =============================================================================
# CMCRank.ai — Production Deployment Script
# Deploys to cmcrank.ai (:3000)
# =============================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"
ENV_SOURCE="$HOME/.config/cmcrank/.env.production"
ENV_TARGET="$PROJECT_DIR/.env.production"
COMPOSE_FILE="$PROJECT_DIR/docker-compose.prod.yml"
DB_PORT=5432
DB_NAME="cmcrank_prod"
DB_USER="cmcrank"
APP_PORT=3000
APP_CONTAINER="cmcrank-app-prod"
DB_CONTAINER="cmcrank-db-prod"
BACKUP_DIR="$HOME/.config/cmcrank/backups/production"

export COMPOSE_PROJECT_NAME=cmcrank-production
...
docker volume create cmcrank_postgres_data_prod 2>/dev/null || true
